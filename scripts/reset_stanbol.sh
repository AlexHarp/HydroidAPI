...
curl --globaloff http://localhost:8080/system/console/configMgr/org.apache.stanbol.enhancer.jobmanager.event.impl.EventJobManagerImpl -H 'Cookie: felix-webconsole-locale=en;' -H 'Accept-Encoding: gzip, deflate' -H 'Accept-Language: en,en-AU;q=0.8' -H 'Authorization: Basic YWRtaW46YWRtaW4=' -H 'X-Requested-With: XMLHttpRequest' -H 'Connection: keep-alive' -H 'Pragma: no-cache' -H 'Content-Type: application/x-www-form-urlencoded; charset=UTF-8' -H 'Accept: */*' -H 'Cache-Control: no-cache' -H 'DNT: 1' --data 'apply=true&action=ajaxConfigManager&%24location=&stanbol.maxEnhancementJobWaitTime=120000&propertylist=stanbol.maxEnhancementJobWaitTime' --compressed
sleep 2s
