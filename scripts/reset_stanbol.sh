...
sudo cp /var/tmp/GA.solrindex.zip /usr/share/tomcat8/stanbol/datafiles/GA.solrindex.zip
printf 'Posting bundle...\n'
# post bundle to OSGi
sudo cp /var/tmp/org.apache.stanbol.data.site.GA-1.0.0.jar /usr/share/tomcat8/stanbol/fileinstall/org.apache.stanbol.data.site.GA-1.0.0.jar
sleep 2s
sudo cp /var/tmp/config/. /usr/share/tomcat8/stanbol/fileinstall/ -R
